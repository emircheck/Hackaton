...
# def get_data(html):
#     soup = BS(html, 'lxml')
#     catalog = soup.find('div',class_='search-result-table')
...
#             price = ''
#         try:
#             img = 'https://www.kivano.kg/mobilnye-telefony' + phone.find('div', class_ ='listbox_img pull-left').find('img').get('src')
#         except:
#             img = ''
